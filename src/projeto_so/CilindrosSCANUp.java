...
public class CilindrosSCANUp implements CalculoCilindros {
	...
	public void ordenaFila() {
		...
		for (int j = 0; j <= tamanhoInicialFilaCima; j++) {
			if (j == 0)
				filaEsperaOrdenada[j] = cilindroAtual;
		...
		for (int i = tamanhoInicialFilaCima + 1; i <= tamanhoInicialFilaBaixo + tamanhoInicialFilaCima; i++ ) {
